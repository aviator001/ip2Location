<h1>INTRODUCTION</h1>
<div>The IP2Location Object is a light weight and fast PHP object, whos primary objective is to determine a users location, by optionally detecting their public IP address, and then converting it into a location.
	<br><br>
